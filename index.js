...
console.log("2" > "12") // -> true т.к. строки сравниваются по кодировке, "2" кодируется в число больше, чем "12"
console.log(undefined === null) // -> false т.к. === - сравнение с типом, а тип у null и undefined разный
console.log(null == "\n0\n") // -> false т.к. == не математический оператор и приведения к числу не происходит
